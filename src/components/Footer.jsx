...
const Footer = () => {
  ...
  <aside>
    <h1 className=" text-lg md:text-xl lg:text-2xl flex gap-0 text-green-500 font-medium md:font-semibold lg:font-extrabold  animate__animated animate__zoomIn animate__delay-1000 my-8 underline ">Haven<span  className="text-pink-500">Homes</span></h1>
